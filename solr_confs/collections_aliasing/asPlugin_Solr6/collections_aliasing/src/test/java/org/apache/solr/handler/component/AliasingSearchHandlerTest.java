...
/**
 * Test framework for AliasingSearchHandlerTest taken from the Solr SearchHandlerTest
 * Currently the ZooKeeper tests are disabled as they fail with "Watch limit violations"
 */
public class AliasingSearchHandlerTest
    ...
    public void testInitialization() {
        ...
        SearchHandler handler = new AliasingSearchHandler();
        handler.init(args);
        handler.inform(core);
        ...
        args = new NamedList();
        args.add(SearchHandler.INIT_COMPONENTS, names0);
        handler = new AliasingSearchHandler();
        handler.init(args);
        handler.inform(core);
...
//    @Ignore("ZK Tests fail with \"Watch limit violations\"")
    @Test
    public void testZkConnected()
            throws Exception {
