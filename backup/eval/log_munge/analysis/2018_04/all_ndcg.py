...
#	SOLR_STUB = "http://144.76.218.178:8989/solr/analytics/select?indent=on&wt=json"
	SOLR_STUB = "http://localhost:8080/solr/test/select?indent=on&wt=json"
...
all_queries = "http://localhost:8080/solr/test/select?facet=on&fq=operation:%22RankedRetrieveRecordInteraction%22&indent=on&q=*:*&rows=0&wt=json&facet.field=query_term&facet.limit=-1&facet.mincount=1"
query_terms = []
...
while i < len(query_terms[::step]):
	...
	solr_qry = "http://localhost:8080/solr/test/select?fl=query_term,filter_term&fq=operation:%22RankedRetrieveRecordInteraction%22&indent=on&wt=json"
