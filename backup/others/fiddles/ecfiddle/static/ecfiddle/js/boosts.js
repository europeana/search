$(document).ready(function(){
    ...
    var concatenate_autocomplete_msg = function(element){
        ...
        var label = "";
        for(k in element.prefLabel){

            label = element.prefLabel['en'];

        }
        var hidden_labels = [];
        for(k in element.hiddenLabel){

            hidden_labels.push(element.hiddenLabel[k]);

        }
        var expansion_label = hidden_labels.join("; ");
        var uri = element.id;
